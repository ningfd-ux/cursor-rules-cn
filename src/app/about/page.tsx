...
export const metadata: Metadata = {
  title: "About",
  description: "Cursor Rules — Production-ready AI coding standards and AI-powered standards generator.",
};
    ...
    <div className="mx-auto max-w-3xl px-4 py-12">
      ...
      <section className="mb-8">
        ...
        <p className="leading-relaxed text-zinc-600 dark:text-zinc-400">
          Every standard includes usage scenarios and common mistakes — not just generic templates.
      ...
      <section className="mb-8">
        ...
        <p className="mb-4 leading-relaxed text-zinc-600 dark:text-zinc-400">
          AI coding tools are changing how teams build software. We built this platform to curate
          the best practices — with real context, anti-patterns, and a code generator that actually
      ...
      <section className="mb-8">
        ...
        <p className="mb-4 leading-relaxed text-zinc-600 dark:text-zinc-400">
          ...
          Each standard is tagged with tool version compatibility and last update date.
        </p>
      </section>
